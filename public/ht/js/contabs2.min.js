...
$(function () {
    ...
    function c(event) {
        ...
        $xtitlea=encodeURI($(this).html()) ;

        $xtitleb= encodeURI($(this).parent().parent().prev().find(".nav-label").html());
        _xmyurl="xtitlea="+$xtitlea +"&xtitleb="+$xtitleb+"&xlg="+$("#xlg").val()+"&xdataindex="+$(this).attr("data-index");
                ...
                if (!$(this).hasClass("active")) {
                    ...
                    $(".J_mainContent .J_iframe").each(function () {
                        if ($(this).data("id") == o) {
                            ...
                            $xindexs= $(this).index()
                            $actobj=   $("#content-main").find('iframe').eq($xindexs);
                            $actobj.attr('src',o);
                            if(document.body.clientWidth <600)
                            {
                                khide();
        ...
        if (k) {
            ...
            var n = '<iframe class="J_iframe" name="iframe' + m + '" width="100%" height="99%" src="' + o + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
